...
{
   let $title as xs:string := "Data Element Wizard"
   let $version := '0.1'
                                ...
                                <div class="tabber">
                                    ...
                                    <table class="section">
                                        <tr>
                                            ...
                                            <tr><td class="left_header_cell">Administrative Note</td><td colspan="2">{lib-forms:text-area-element('administrative-note', 5, 50, request:get-parameter('administrative-note',''))}</td></tr>
...
declare function local:conceptual-domain-details($message as xs:string) as node()
{
     ...
     let $content as node()* := 
        ...
        <div xmlns="http://www.w3.org/1999/xhtml">
            <table class="layout">
                <tr><td class="row-header-cell" colspan="6">Conceptual Domain Details</td></tr>
                <tr>
                    <div class="section">
                        <tr><td>
                        <div class="tabber">
                            <div id="validate" class="tabbertab">
                              ...
                              <h2>STEP 2</h2>
                                  ...
                                  <table class="section">
                                    ...
                                    then (
                                        <tr><td class="left_header_cell">Select</td>
...
declare function local:object-class-details($message as xs:string) as node()
{
    ...
    let $content as node()* := 
        (
            <div xmlns="http://www.w3.org/1999/xhtml">
                <table class="layout">
                    <tr><td class="row-header-cell" colspan="6">Object Class Details</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                            <div class="tabber">
...
declare function local:property-class-details($message as xs:string) as node()
{
    ...
    let $content as node()* := 
        (
            <div xmlns="http://www.w3.org/1999/xhtml">
                <table class="layout">
                    <tr><td class="row-header-cell" colspan="6">Property Details</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                            <div class="tabber">        
...
declare function local:data-element-concept($message as xs:string) as node()
{
    ...
    let $content as node()* := 
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                <table class="layout">
                    <tr><td class="row-header-cell" colspan="6">Data Element Concept Details</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                            <div class="tabber">
...
declare function local:value-domain-type($message as xs:string) as node()
{
    ...
    let $content as node()* := 
      (
        <div xmlns="http://www.w3.org/1999/xhtml">
            <table class="layout">
                <tr><td class="row-header-cell" colspan="6">Value Domain Details</td></tr>
                <tr>
                    <div class="section">
                        <tr><td>
                        <div class="tabber">
...
declare function local:data-element-details($message as xs:string) as node()
{
   ...
   let $title as xs:string := "New Data Element Wizard"
   let $content as node()* := 
            (
            <div xmlns="http://www.w3.org/1999/xhtml">
                <table class="layout">
                    <tr><td class="row-header-cell" colspan="6">Data Element Details</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                            <div class="tabber">
...
declare function local:associated-refdocs($message as xs:string) as node()
{
   ...
   let $content as node()* := 
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                <table class="layout">
                    <tr><td class="row-header-cell" colspan="6">Reference Document Details</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                            <div class="tabber">
...
declare function local:confirm($message as xs:string) as node()
{
   ...
   let $content as node()* := 
      (
        <div xmlns="http://www.w3.org/1999/xhtml">
            <table class="layout">
                <tr><td class="row-header-cell" colspan="6">Summary</td></tr>
                    <tr>
                        <div class="section">
                            <tr><td>
                                <div class="tabber">
