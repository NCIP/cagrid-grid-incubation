 ...
 * 
 */
public class Service2Authorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service2.introduce.cagrid.org/Service2";
	
	
	public Service2Authorization() {
	}
	...
	public static void authorizeCapitalize() throws RemoteException {
		
		
	}
					
	public static void authorizeSecureCapitalize() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("capitalize")){
			try{
				authorizeCapitalize();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("secureCapitalize")){
			try{
				authorizeSecureCapitalize();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
