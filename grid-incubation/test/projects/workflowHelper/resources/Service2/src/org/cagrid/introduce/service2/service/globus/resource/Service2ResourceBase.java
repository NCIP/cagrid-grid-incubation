 ...
 * 
 */
public abstract class Service2ResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(Service2ResourceBase.class);

	private Service2ResourceConfiguration configuration;
	...
	public Service2ResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Service2ResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
