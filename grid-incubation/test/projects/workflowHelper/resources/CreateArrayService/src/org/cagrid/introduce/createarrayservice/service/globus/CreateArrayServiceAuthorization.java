 ...
 * 
 */
public class CreateArrayServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://createarrayservice.introduce.cagrid.org/CreateArrayService";
	
	
	public CreateArrayServiceAuthorization() {
	}
	...
	public static void authorizeGetArray() throws RemoteException {
		
		
	}
					
	public static void authorizeGetComplexArray() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getArray")){
			try{
				authorizeGetArray();
				return true;
			} catch (Exception e){
