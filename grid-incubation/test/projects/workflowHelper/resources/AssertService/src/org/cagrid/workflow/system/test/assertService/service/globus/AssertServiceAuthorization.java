 ...
 * 
 */
public class AssertServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://assertService.test.system.workflow.cagrid.org/AssertService";
	
	
	public AssertServiceAuthorization() {
	}
	...
	public static void authorizeAssertEquals() throws RemoteException {
		
		
	}
					
	public static void authorizeAssertNumbersEqual() throws RemoteException {
		
		
	}
					
	public static void authorizeSecureAssertEquals() throws RemoteException {
		
		
	}
					
	public static void authorizeSecureAssertNumberEquals() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("assertEquals")){
			try{
				authorizeAssertEquals();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("assertNumbersEqual")){
			try{
				authorizeAssertNumbersEqual();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("secureAssertEquals")){
			try{
				authorizeSecureAssertEquals();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
