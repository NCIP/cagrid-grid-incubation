 ...
 * 
 */
public abstract class AssertServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(AssertServiceResourceBase.class);

	private AssertServiceResourceConfiguration configuration;
    ...
    public AssertServiceResourceBase() {
    }
	...
	public AssertServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (AssertServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
