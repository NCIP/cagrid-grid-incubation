 ...
 * 
 */
public abstract class Service4ResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(Service4ResourceBase.class);

	private Service4ResourceConfiguration configuration;
	...
	public Service4ResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Service4ResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
