 ...
 * 
 */
public class Service1Authorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service1.introduce.cagrid.org/Service1";
	
	
	public Service1Authorization() {
	}
	...
	public static void authorizeGenerateData() throws RemoteException {
		
		
	}
					
	public static void authorizeSecureGenerateData() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("generateData")){
			try{
				authorizeGenerateData();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("secureGenerateData")){
			try{
				authorizeSecureGenerateData();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
