...
import org.cagrid.introduce.service1.service.Service1Configuration;
import java.io.File;
 ...
 * 
 */
public abstract class Service1ResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(Service1ResourceBase.class);

	private Service1ResourceConfiguration configuration;
	...
	public Service1ResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Service1ResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
