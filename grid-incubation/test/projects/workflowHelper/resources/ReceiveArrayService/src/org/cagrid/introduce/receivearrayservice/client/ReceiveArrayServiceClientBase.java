 ...
 */
public abstract class ReceiveArrayServiceClientBase extends ServiceSecurityClient {	
	...
	public ReceiveArrayServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public ReceiveArrayServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
