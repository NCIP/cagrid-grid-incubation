...
public class DelegationAdminClient {
	 ...
	 * 
	 * @param gridIdentity The grid identity of the user to add as a CDS administrator.
	 * @throws RemoteException
	 * @throws CDSInternalFault
	 * @throws PermissionDeniedFault
	 */

	public void addAdmin(String gridIdentity) throws RemoteException,
	 ...
	 * @param gridIdentity The Grid Identity of the user to remove from the CDS administrators group.
	 * @throws RemoteException
	 * @throws CDSInternalFault
	 * @throws PermissionDeniedFault
	 */

	public void removeAdmin(String gridIdentity) throws RemoteException,
			CDSInternalFault, PermissionDeniedFault {
	...
	public List<String> getAdmins() throws RemoteException, CDSInternalFault,
			PermissionDeniedFault {
