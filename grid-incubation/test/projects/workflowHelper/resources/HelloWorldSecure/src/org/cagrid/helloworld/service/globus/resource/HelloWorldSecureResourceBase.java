...
import org.cagrid.helloworld.service.HelloWorldSecureConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class HelloWorldSecureResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(HelloWorldSecureResourceBase.class);

	private HelloWorldSecureResourceConfiguration configuration;
    ...
    public HelloWorldSecureResourceBase() {
    }
	...
	public HelloWorldSecureResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (HelloWorldSecureResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
