...
import org.cagrid.introduce.service3.service.Service3Configuration;
import java.io.File;
 ...
 * 
 */
public abstract class Service3ResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(Service3ResourceBase.class);

	private Service3ResourceConfiguration configuration;
	...
	public Service3ResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Service3ResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
