...
import org.cagrid.workflow.test.validateoutputsservice.service.ValidateOutputsServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ValidateOutputsServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ValidateOutputsServiceResourceBase.class);

	private ValidateOutputsServiceResourceConfiguration configuration;
    ...
    public ValidateOutputsServiceResourceBase() {
    }
	...
	public ValidateOutputsServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/ValidateOutputsService";
		...
		try {
			...
			this.configuration = (ValidateOutputsServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
