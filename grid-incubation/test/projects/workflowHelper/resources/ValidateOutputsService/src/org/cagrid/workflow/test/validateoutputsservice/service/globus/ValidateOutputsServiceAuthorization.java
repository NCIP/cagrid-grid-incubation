 ...
 * 
 */
public class ValidateOutputsServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://validateoutputsservice.test.workflow.cagrid.org/ValidateOutputsService";
	
	
	public ValidateOutputsServiceAuthorization() {
	}
	...
	public static void authorizeValidateTestOutput() throws RemoteException {
		
		
	}
					
	public static void authorizeSecureValidateTestOutput() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("validateTestOutput")){
			try{
				authorizeValidateTestOutput();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("secureValidateTestOutput")){
			try{
				authorizeSecureValidateTestOutput();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
