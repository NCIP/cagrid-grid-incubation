package org.cagrid.second.service.globus.resource;

import org.cagrid.second.common.SecondConstants;
import org.cagrid.second.stubs.SecondResourceProperties;
 ...
 * 
 */
public class SecondResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(SecondResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    SecondResourceProperties props = new SecondResourceProperties();
			SecondResource resource = new SecondResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, SecondConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, SecondConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		SecondResource resource = (SecondResource) super.find(key);
		return resource;
	}
     ...
     */
    public SecondResource getAddressedResource() throws Exception {
        SecondResource thisResource;
        thisResource = (SecondResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}