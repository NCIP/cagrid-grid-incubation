 ...
 * 
 */
public abstract class SecondResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(SecondResourceBase.class);

	private SecondResourceConfiguration configuration;
	...
	public SecondResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (SecondResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
