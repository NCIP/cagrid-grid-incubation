 ...
 * 
 */
public class SecondAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://second.cagrid.org/Second";
	
	
	public SecondAuthorization() {
	}
	...
	public static void authorizeReceive() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("receive")){
			try{
				authorizeReceive();
				return true;
			} catch (Exception e){
