 ...
 * 
 */
public abstract class FirstResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(FirstResourceBase.class);

	private FirstResourceConfiguration configuration;
	...
	public FirstResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (FirstResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
