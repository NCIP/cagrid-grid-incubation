package org.cagrid.first.service.globus.resource;

import org.cagrid.first.common.FirstConstants;
import org.cagrid.first.stubs.FirstResourceProperties;
 ...
 * 
 */
public class FirstResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(FirstResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    FirstResourceProperties props = new FirstResourceProperties();
			FirstResource resource = new FirstResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, FirstConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, FirstConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		FirstResource resource = (FirstResource) super.find(key);
		return resource;
	}
     ...
     */
    public FirstResource getAddressedResource() throws Exception {
        FirstResource thisResource;
        thisResource = (FirstResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}