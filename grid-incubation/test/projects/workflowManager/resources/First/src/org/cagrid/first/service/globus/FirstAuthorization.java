 ...
 * 
 */
public class FirstAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://first.cagrid.org/First";
	...
	public static void authorizePrint() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("print")){
			try{
				authorizePrint();
				return true;
			} catch (Exception e){
