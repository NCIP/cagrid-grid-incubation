...
import org.cagrid.iso21090.service.ISO21090AnalyticalServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ISO21090AnalyticalServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ISO21090AnalyticalServiceResourceBase.class);

	private ISO21090AnalyticalServiceResourceConfiguration configuration;
    ...
    public ISO21090AnalyticalServiceResourceBase() {
    }
	...
	public ISO21090AnalyticalServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/ISO21090AnalyticalService";
		...
		try {
			...
			this.configuration = (ISO21090AnalyticalServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
