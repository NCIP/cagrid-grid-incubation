...
public class QueryModifierProcessor {
    ...
    private static List<TargetAttribute[]> handleAttributeList(String targetObjectName, List<Object> baseObjects, NamedAttribute[] attributes)
        throws QueryProcessingException {
        ...
        for (NamedAttribute attribute : attributes) {
            ...
            try {
                attributeGetter = ClassAccessUtilities.getNamedGetterMethod(targetClass, attribute.getAttributeName());
            } catch (Exception ex) {
                throw new QueryProcessingException("Error finding getter for field of target object: " + ex.getMessage(), ex);
            }
        ...
        for (Object instance : baseObjects) {
            ...
            for (NamedAttribute attribute : attributes) {
                ...
                try {
                    ...
                    throw new QueryProcessingException("Error extracting value of attribute field: " + ex.getMessage(), ex);
                }
    ...
    private static String valueToString(Object rawValue) {
        ...
        // TODO: value to string needs a smarter impl dates
