 ...
 */
public abstract class TideContextClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected TideContextPortType portType;
	...
	public TideContextClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public TideContextClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private TideContextPortType createPortType() throws RemoteException {

		TideContextServiceAddressingLocator locator = new TideContextServiceAddressingLocator();
		...
		TideContextPortType port = null;
		try {
			port = locator.getTideContextPortTypePort(getEndpointReference());
		} catch (Exception e) {
