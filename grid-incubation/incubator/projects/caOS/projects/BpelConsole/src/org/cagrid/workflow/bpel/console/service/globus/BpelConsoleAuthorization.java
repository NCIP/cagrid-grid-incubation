 ...
 * 
 */
public class BpelConsoleAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://console.bpel.workflow.cagrid.org/BpelConsole";
	
	
	public BpelConsoleAuthorization() {
	}
