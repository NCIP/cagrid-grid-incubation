 ...
 * 
 */
public abstract class BpelConsoleResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(BpelConsoleResourceBase.class);

	private BpelConsoleResourceConfiguration configuration;
    ...
    public BpelConsoleResourceBase() {
    }
	...
	public BpelConsoleResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (BpelConsoleResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
