 ...
 * 
 */
public abstract class WorkflowManagerServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(WorkflowManagerServiceResourceBase.class);

	private WorkflowManagerServiceResourceConfiguration configuration;
    ...
    public WorkflowManagerServiceResourceBase() {
    }
	...
	public WorkflowManagerServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/WorkflowManagerService";
		...
		try {
			...
			this.configuration = (WorkflowManagerServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
