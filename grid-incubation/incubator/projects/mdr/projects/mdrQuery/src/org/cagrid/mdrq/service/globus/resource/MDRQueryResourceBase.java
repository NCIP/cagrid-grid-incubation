...
import org.cagrid.mdrq.common.MDRQueryConstants;
import org.cagrid.mdrq.stubs.MDRQueryResourceProperties;
import org.cagrid.mdrq.service.MDRQueryConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class MDRQueryResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(MDRQueryResourceBase.class);

	private MDRQueryResourceConfiguration configuration;
	...
	public org.cancergrid.schema.config.Resources getResources(){
		return ((MDRQueryResourceProperties) getResourceBean()).getResources();
	}
	
	public void setResources(org.cancergrid.schema.config.Resources resources ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(MDRQueryConstants.RESOURCES);
		prop.set(0, resources);
	}
	...
	public MDRQueryResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (MDRQueryResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
