 ...
 * 
 */
public class MDRQueryAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://mdrq.cagrid.org/MDRQuery";
	
	Map authorizationClassMap = new HashMap();
	
	
	public MDRQueryAuthorization() {
	}
	...
	public void authorizeGetQueryResources(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getQueryResources")){
			authorizeGetQueryResources(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
