...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" exclude-result-prefixes="#all">
    ...
    <xsl:template match="DescLogicConcept">
        ...
        <concept>
            <names>
                <id>US-NCICB-CACORE-EVS-DESCLOGICCONCEPT-<xsl:value-of select="Code"/>
                </id>
                <preferred>
                    <xsl:value-of select="PropertyCollection/Property[Name='Preferred_Name']/Value"/>
                </preferred>
                <all-names>
                    <name>
                        <xsl:value-of select="PropertyCollection/Property[Name='Preferred_Name']/Value"/>
            ...
            <definition>
                <xsl:value-of select="PropertyCollection/Property[Name='DEFINITION']/Value"/>
            </definition>
