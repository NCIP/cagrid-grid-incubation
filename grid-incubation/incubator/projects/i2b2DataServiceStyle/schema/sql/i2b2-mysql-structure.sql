...
CREATE TABLE code_lookup ( table_cd varchar(100) NOT NULL, column_cd varchar(100) NOT NULL, code_cd varchar(50) NOT NULL, name_char varchar(650), LOOKUP_BLOB text, UPLOAD_DATE datetime, UPDATE_DATE datetime, DOWNLOAD_DATE datetime, IMPORT_DATE datetime, SOURCESYSTEM_CD varchar(50), UPLOAD_ID int, PRIMARY KEY (table_cd, column_cd, code_cd) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE concept_dimension ( CONCEPT_PATH varchar(700) NOT NULL, CONCEPT_CD varchar(50) NOT NULL, NAME_CHAR varchar(2000), CONCEPT_BLOB longtext, UPDATE_DATE date, DOWNLOAD_DATE date, IMPORT_DATE date, SOURCESYSTEM_CD varchar(50), UPLOAD_ID decimal, TABLE_NAME TINYTEXT, ENCODING_CD varchar(25) NOT NULL, PRIMARY KEY (CONCEPT_PATH) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE datamart_report ( TOTAL_PATIENT int, TOTAL_OBSERVATIONFACT int, TOTAL_EVENT int, REPORT_DATE datetime ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE encoding_dimension;
/*
CREATE TABLE encoding_dimension ( ENCODING_CD varchar(25) NOT NULL, ENCODING_NAME varchar(25) NOT NULL, ENCODING_VERSION decimal(38,2) NOT NULL, ENCODING_DESC varchar(200), CREATE_USER varchar(50), UPDATE_USER varchar(50), CREATE_DATE date, UPDATE_DATE date, PRIMARY KEY (ENCODING_CD) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
*/
...
CREATE TABLE encounter_mapping ( ENCOUNTER_IDE varchar(200) NOT NULL, ENCOUNTER_IDE_SOURCE varchar(50) NOT NULL, ENCOUNTER_NUM int NOT NULL, PATIENT_IDE varchar(200), PATIENT_IDE_SOURCE varchar(50), ENCOUNTER_IDE_STATUS varchar(50), UPLOAD_DATE datetime, UPDATE_DATE datetime, DOWNLOAD_DATE datetime, IMPORT_DATE datetime, SOURCESYSTEM_CD varchar(50), UPLOAD_ID int, PRIMARY KEY (ENCOUNTER_IDE, ENCOUNTER_IDE_SOURCE) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE i2b2 (
  ...
  C_FACTTABLECOLUMN varchar(50) NOT NULL, C_TABLENAME varchar(50) NOT NULL,
  C_TABLENAME varchar(50) NOT NULL, C_COLUMNNAME varchar(50) NOT NULL,
  C_COLUMNDATATYPE varchar(50) NOT NULL, C_OPERATOR varchar(10) NOT NULL,
...
CREATE TABLE irb_approval_type ( IRB_APPROVAL_TYPE_CD varchar(3) NOT NULL, IRB_APPROVAL_TYPE_DESC varchar(50) NOT NULL, CREATE_USER varchar(50), UPDATE_USER varchar(50), CREATE_DATE date, UPDATE_DATE date, PRIMARY KEY (IRB_APPROVAL_TYPE_CD) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE map_aggr_fact;
/* The UCSF i2b2 database doesn't have a primary key on this table at all
CREATE TABLE map_aggr_fact ( CONCEPT_PATH varchar(700) NOT NULL, MAP_ID decimal NOT NULL, VALTYPE_CD varchar(3), TVAL_CHAR TINYTEXT, NVAL_NUM decimal(18,5), QUANTITY_NUM decimal(18,5), UNITS_CD varchar(100), CONFIDENCE_NUM decimal, MAP_DATE date, PRIMARY KEY (CONCEPT_PATH, MAP_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
*/
CREATE TABLE map_aggr_fact ( CONCEPT_PATH varchar(700) NOT NULL, MAP_ID decimal NOT NULL, VALTYPE_CD varchar(3), TVAL_CHAR TINYTEXT, NVAL_NUM decimal(18,5), QUANTITY_NUM decimal(18,5), UNITS_CD varchar(100), CONFIDENCE_NUM decimal, MAP_DATE date) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE map_request ( MAP_REQUEST_ID decimal NOT NULL, CONCEPT_PATH varchar(700) NOT NULL, TARGET_ENCODING varchar(25) NOT NULL, USER_ID varchar(20) NOT NULL, REQUEST_DESC varchar(200), REQUEST_DATE date, MAP_ID decimal, PRIMARY KEY (MAP_REQUEST_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE patient_dimension ( PATIENT_NUM decimal NOT NULL, VITAL_STATUS_CD varchar(3), BIRTH_DATE date, DEATH_DATE date, SEX_CD char(1), AGE_IN_YEARS_NUM decimal, LANGUAGE_CD varchar(50), RACE_CD varchar(50), MARITAL_STATUS_CD varchar(50), RELIGION_CD varchar(50), ZIP_CD varchar(10), STATECITYZIP_PATH varchar(150), PATIENT_BLOB longtext, UPDATE_DATE date, DOWNLOAD_DATE date, IMPORT_DATE date, SOURCESYSTEM_CD varchar(50), UPLOAD_ID decimal, PRIMARY KEY (PATIENT_NUM) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE patient_mapping;
CREATE TABLE patient_mapping ( PATIENT_IDE varchar(200) NOT NULL, PATIENT_IDE_SOURCE varchar(50) NOT NULL, PATIENT_NUM int NOT NULL, PATIENT_IDE_STATUS varchar(50), UPLOAD_DATE datetime, UPDATE_DATE datetime, DOWNLOAD_DATE datetime, IMPORT_DATE datetime, SOURCESYSTEM_CD varchar(50), UPLOAD_ID int, PRIMARY KEY (PATIENT_IDE, PATIENT_IDE_SOURCE) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE provider_dimension ( PROVIDER_PATH varchar(700) NOT NULL, PROVIDER_ID varchar(20) NOT NULL, NAME_CHAR varchar(2000), PROVIDER_BLOB longtext, UPDATE_DATE date, DOWNLOAD_DATE date, IMPORT_DATE date, SOURCESYSTEM_CD varchar(50), UPLOAD_ID int, PRIMARY KEY (PROVIDER_PATH) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
*/
CREATE TABLE provider_dimension ( PROVIDER_PATH varchar(700) NOT NULL, PROVIDER_ID varchar(50) NOT NULL, NAME_CHAR varchar(2000), PROVIDER_BLOB longtext, UPDATE_DATE date, DOWNLOAD_DATE date, IMPORT_DATE date, SOURCESYSTEM_CD varchar(50), UPLOAD_ID int) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE qt_patient_enc_collection;
CREATE TABLE qt_patient_enc_collection ( PATIENT_ENC_COLL_ID int NOT NULL AUTO_INCREMENT, RESULT_INSTANCE_ID int, SET_INDEX int, PATIENT_NUM int, ENCOUNTER_NUM int, PRIMARY KEY (PATIENT_ENC_COLL_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE qt_patient_set_collection ( PATIENT_SET_COLL_ID bigint NOT NULL AUTO_INCREMENT, RESULT_INSTANCE_ID int, SET_INDEX int, PATIENT_NUM int, PRIMARY KEY (PATIENT_SET_COLL_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE qt_query_result_type ( RESULT_TYPE_ID int NOT NULL, NAME varchar(100), DESCRIPTION varchar(200), PRIMARY KEY (RESULT_TYPE_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE qt_query_status_type;
CREATE TABLE qt_query_status_type ( STATUS_TYPE_ID int NOT NULL, NAME varchar(100), DESCRIPTION varchar(200), PRIMARY KEY (STATUS_TYPE_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE qt_xml_result;
CREATE TABLE qt_xml_result ( XML_RESULT_ID int NOT NULL AUTO_INCREMENT, RESULT_INSTANCE_ID int, XML_VALUE text, PRIMARY KEY (XML_RESULT_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE query_criteria ( QUERY_ID decimal NOT NULL, CONCEPT_PATH varchar(700) NOT NULL, IS_VALID char(1), PRIMARY KEY (QUERY_ID, CONCEPT_PATH) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE query_dimension ( QUERY_ID decimal NOT NULL, QUERY_NAME varchar(200) NOT NULL, USER_ID varchar(20) NOT NULL, CREATE_DATE date, UPDATE_DATE date, PRIMARY KEY (QUERY_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE request_status ( REQUEST_STATUS_CD char(1) NOT NULL, REQUEST_STATUS_DESC varchar(50) NOT NULL, CREATE_USER varchar(50), UPDATE_USER varchar(50), CREATE_DATE date, UPDATE_DATE date, PRIMARY KEY (REQUEST_STATUS_CD) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE research_type;
CREATE TABLE research_type ( RESEARCH_TYPE_CD varchar(3) NOT NULL, RESEARCH_TYPE_DESC varchar(50) NOT NULL, CREATE_USER varchar(50), UPDATE_USER varchar(50), CREATE_DATE date, UPDATE_DATE date, PRIMARY KEY (RESEARCH_TYPE_CD) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE schemes;
CREATE TABLE schemes ( C_KEY varchar(50) NOT NULL, C_NAME varchar(50) NOT NULL, C_DESCRIPTION varchar(100), PRIMARY KEY (C_KEY) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE set_type;
CREATE TABLE set_type ( ID int NOT NULL, NAME varchar(500), CREATE_DATE datetime, PRIMARY KEY (ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE set_upload_status;
CREATE TABLE set_upload_status ( UPLOAD_ID int NOT NULL, SET_TYPE_ID int NOT NULL, SOURCE_CD varchar(50) NOT NULL, NO_OF_RECORD bigint, LOADED_RECORD bigint, DELETED_RECORD bigint, LOAD_DATE datetime NOT NULL, END_DATE datetime, LOAD_STATUS varchar(100), MESSAGE varchar(4000), INPUT_FILE_NAME varchar(500), LOG_FILE_NAME varchar(500), TRANSFORM_NAME varchar(500), PRIMARY KEY (UPLOAD_ID, SET_TYPE_ID) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE source_master ( SOURCE_CD varchar(50) NOT NULL, DESCRIPTION varchar(300), CREATE_DATE datetime, PRIMARY KEY (SOURCE_CD) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
DROP TABLE study_criteria;
CREATE TABLE study_criteria ( DATA_REQUEST_ID decimal NOT NULL, CONCEPT_PATH varchar(700) NOT NULL, ENCODING_REQD varchar(25), PARAMETERS varchar(200), IS_VALID char(1), PRIMARY KEY (DATA_REQUEST_ID, CONCEPT_PATH) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
