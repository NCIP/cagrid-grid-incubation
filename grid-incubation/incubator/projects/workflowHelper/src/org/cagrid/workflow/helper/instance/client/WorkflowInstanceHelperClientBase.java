 ...
 */
public abstract class WorkflowInstanceHelperClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected WorkflowInstanceHelperPortType portType;
	...
	public WorkflowInstanceHelperClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public WorkflowInstanceHelperClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private WorkflowInstanceHelperPortType createPortType() throws RemoteException {

		WorkflowInstanceHelperServiceAddressingLocator locator = new WorkflowInstanceHelperServiceAddressingLocator();
		...
		WorkflowInstanceHelperPortType port = null;
		try {
			port = locator.getWorkflowInstanceHelperPortTypePort(getEndpointReference());
		} catch (Exception e) {
    ...
    public void deliver(List topicPath, EndpointReferenceType producer, Object message) {
        ...
        if (changeMessage != null) {
            System.out.println("[WorkflowInstanceHelperClientBase.deliver] Got notification");
        }
