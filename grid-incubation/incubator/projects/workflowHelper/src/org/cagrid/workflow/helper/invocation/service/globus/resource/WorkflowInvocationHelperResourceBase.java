...
public abstract class WorkflowInvocationHelperResourceBase extends ReflectionResource implements Resource
    ...
    public WorkflowInvocationHelperResourceBase() {
    }
	...
	public void setTerminationTime(Calendar time) {	
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(WorkflowInvocationHelperConstants.TERMINATIONTIME));
	...
	public void setWorkflowInvocationHelperDescriptor(org.cagrid.workflow.helper.descriptor.WorkflowInvocationHelperDescriptor workflowInvocationHelperDescriptor ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowInvocationHelperConstants.WORKFLOWINVOCATIONHELPERDESCRIPTOR);
		prop.set(0, workflowInvocationHelperDescriptor);
	}
	
	
	
	public org.cagrid.workflow.helper.descriptor.OperationInputMessageDescriptor getOperationInputMessageDescriptor(){
		return ((WorkflowInvocationHelperResourceProperties) getResourceBean()).getOperationInputMessageDescriptor();
	}
	
	public void setOperationInputMessageDescriptor(org.cagrid.workflow.helper.descriptor.OperationInputMessageDescriptor operationInputMessageDescriptor ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowInvocationHelperConstants.OPERATIONINPUTMESSAGEDESCRIPTOR);
		prop.set(0, operationInputMessageDescriptor);
	}
	
	
	
	public org.cagrid.workflow.helper.descriptor.OperationOutputTransportDescriptor getOperationOutputTransportDescriptor(){
		return ((WorkflowInvocationHelperResourceProperties) getResourceBean()).getOperationOutputTransportDescriptor();
	}
	
	public void setOperationOutputTransportDescriptor(org.cagrid.workflow.helper.descriptor.OperationOutputTransportDescriptor operationOutputTransportDescriptor ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowInvocationHelperConstants.OPERATIONOUTPUTTRANSPORTDESCRIPTOR);
		prop.set(0, operationOutputTransportDescriptor);
	}
	
	
	
	public org.cagrid.workflow.helper.descriptor.TimestampedStatus getTimestampedStatus(){
		return ((WorkflowInvocationHelperResourceProperties) getResourceBean()).getTimestampedStatus();
	}
	...
	public void setTimestampedStatus(org.cagrid.workflow.helper.descriptor.TimestampedStatus timestampedStatus ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowInvocationHelperConstants.TIMESTAMPEDSTATUS);
	...
	public org.cagrid.workflow.helper.descriptor.InstrumentationRecord getInstrumentationRecord(){
		return ((WorkflowInvocationHelperResourceProperties) getResourceBean()).getInstrumentationRecord();
	}
	...
	public void setInstrumentationRecord(org.cagrid.workflow.helper.descriptor.InstrumentationRecord instrumentationRecord ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowInvocationHelperConstants.INSTRUMENTATIONRECORD);
