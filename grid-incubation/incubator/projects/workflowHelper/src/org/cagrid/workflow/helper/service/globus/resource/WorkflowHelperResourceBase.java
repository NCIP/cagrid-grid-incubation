...
public abstract class WorkflowHelperResourceBase extends ReflectionResource implements Resource
	...
	private WorkflowHelperResourceConfiguration configuration;
	...
	public WorkflowHelperResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (WorkflowHelperResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
