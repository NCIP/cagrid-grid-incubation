...
import org.cagrid.workflow.helper.stubs.WorkflowHelperPortType;
import org.cagrid.workflow.helper.stubs.service.WorkflowHelperServiceAddressingLocator;
 ...
 */
public abstract class WorkflowHelperClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected WorkflowHelperPortType portType;
	...
	public WorkflowHelperClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public WorkflowHelperClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private WorkflowHelperPortType createPortType() throws RemoteException {

		WorkflowHelperServiceAddressingLocator locator = new WorkflowHelperServiceAddressingLocator();
		...
		WorkflowHelperPortType port = null;
		try {
			port = locator.getWorkflowHelperPortTypePort(getEndpointReference());
		} catch (Exception e) {
