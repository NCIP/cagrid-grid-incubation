 ...
 * 
 */
public abstract class TideResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(TideResourceBase.class);

	private TideResourceConfiguration configuration;
	...
	public TideResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (TideResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
