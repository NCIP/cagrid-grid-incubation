 ...
 * 
 */
public class TideContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://tide.cagrid.org/Tide/Context";
	
	
	public TideContextAuthorization() {
	}
	...
	public static void authorizeGetWave() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getWave")){
			try{
				authorizeGetWave();
				return true;
			} catch (Exception e){
