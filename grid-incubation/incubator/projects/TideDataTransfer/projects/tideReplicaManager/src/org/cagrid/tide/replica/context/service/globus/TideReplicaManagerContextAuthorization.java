 ...
 * 
 */
public class TideReplicaManagerContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://replica.tide.cagrid.org/TideReplicaManager/Context";
	
	
	public TideReplicaManagerContextAuthorization() {
	}
	...
	public static void authorizeAddReplicaHost() throws RemoteException {
		
		
	}
					
	public static void authorizeGetReplicas() throws RemoteException {
		
		
	}
					
	public static void authorizeReportUnreachableReplicaHost() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("addReplicaHost")){
			try{
				authorizeAddReplicaHost();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getReplicas")){
			try{
				authorizeGetReplicas();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("reportUnreachableReplicaHost")){
			try{
				authorizeReportUnreachableReplicaHost();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
