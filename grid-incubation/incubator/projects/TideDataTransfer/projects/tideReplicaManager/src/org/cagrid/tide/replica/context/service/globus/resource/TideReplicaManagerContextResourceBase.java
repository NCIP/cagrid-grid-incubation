 ...
 * 
 */
public abstract class TideReplicaManagerContextResourceBase extends ReflectionResource implements Resource
                                                  ,PersistenceCallback
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(TideReplicaManagerContextResourceBase.class);

	private TideReplicaManagerContextResourceConfiguration configuration;
    ...
    public TideReplicaManagerContextResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(TideReplicaManagerContextResourceProperties.class,TideReplicaManagerConfiguration.getConfiguration());
            resourcePersistenceHelper = new FilePersistenceHelper(this.getClass(),TideReplicaManagerConfiguration.getConfiguration(),".resource");
        } catch (Exception ex) {
	...
	public org.cagrid.tide.descriptor.TideReplicasDescriptor getTideReplicasDescriptor(){
		return ((TideReplicaManagerContextResourceProperties) getResourceBean()).getTideReplicasDescriptor();
	}
	
	public void setTideReplicasDescriptor(org.cagrid.tide.descriptor.TideReplicasDescriptor tideReplicasDescriptor ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(TideReplicaManagerContextConstants.TIDEREPLICASDESCRIPTOR);
		prop.set(0, tideReplicasDescriptor);
        //call the first store to persist the resource
        store();
	}
	...
	public TideReplicaManagerContextResourceConfiguration getConfiguration() {
		...
		servicePath+="/TideReplicaManagerContext";
		...
		try {
			...
			this.configuration = (TideReplicaManagerContextResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
    ...
    public void load(ResourceKey resourceKey) throws ResourceException, NoSuchResourceException, InvalidResourceKeyException {
	  beingLoaded = true;
	   ...
	   TideReplicaManagerContextResourceProperties props = (TideReplicaManagerContextResourceProperties)resourcePropertyPersistenceHelper.load(TideReplicaManagerContextResourceProperties.class, resourceKey.getValue());
       this.initialize(props, TideReplicaManagerContextConstants.RESOURCE_PROPERTY_SET, resourceKey.getValue());
