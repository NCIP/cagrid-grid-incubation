...
public class GroupSearchDialog extends JDialog {
     ...
     * @param owner
     */
    public GroupSearchDialog(Application application) {
    ...
    private JPanel getTitlePanel() {
        if (titlePanel == null) {
            titlePanel = new TitlePanel("Select Group",
                "A group is a collection of users/hosts in which permissions can be granted to.");
        }
        return titlePanel;
    }
    ...
    private JPanel getResultsPanel() {
        if (resultsPanel == null) {
            ...
            resultsPanel.setBorder(BorderFactory.createTitledBorder(null, "Groups", TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        if (select == null) {
            ...
            select.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    GroupEntry entry = (GroupEntry) getGroups().getSelectedValue();
                    if (entry == null) {
                        ErrorDialog.showError("Please select a group.");
                    } else {
                        selectedGroup = entry.getGroup();
                        dispose();
                    }
                }
            });
