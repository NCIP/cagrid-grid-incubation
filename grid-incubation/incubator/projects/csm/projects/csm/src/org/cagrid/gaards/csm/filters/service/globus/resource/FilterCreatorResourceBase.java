 ...
 * 
 */
public abstract class FilterCreatorResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(FilterCreatorResourceBase.class);

	private FilterCreatorResourceConfiguration configuration;
    ...
    public FilterCreatorResourceBase() {
    }
	...
	public FilterCreatorResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (FilterCreatorResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
