 ...
 * 
 */
public class FilterCreatorAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://csm.gaards.cagrid.org/CSM/FilterCreator";
	
	Map authorizationClassMap = new HashMap();
	
	
	public FilterCreatorAuthorization() {
	}
	...
	public void authorizeGetClassNames(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetAssociatedClassNames(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetAssociatedAttributes(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetFilterClauseBean(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getClassNames")){
			authorizeGetClassNames(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getAssociatedClassNames")){
			authorizeGetAssociatedClassNames(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getAssociatedAttributes")){
			authorizeGetAssociatedAttributes(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getFilterClauseBean")){
			authorizeGetFilterClauseBean(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
