...
import org.cagrid.gaards.csm.filters.common.FilterCreatorConstants;
import org.cagrid.gaards.csm.filters.stubs.FilterCreatorResourceProperties;
 ...
 * 
 */
public class FilterCreatorResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		FilterCreatorResource resource = (FilterCreatorResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		FilterCreatorResourceProperties props = new FilterCreatorResourceProperties();
        ...
        resource.initialize(props, FilterCreatorConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.cagrid.gaards.csm.filters.stubs.types.FilterCreatorReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public FilterCreatorResource getResource(ResourceKey key) throws ResourceException {
		FilterCreatorResource thisResource = (FilterCreatorResource)find(key);
		return thisResource;
	}
     ...
     */
    public FilterCreatorResource getAddressedResource() throws Exception {
        FilterCreatorResource thisResource;
        thisResource = (FilterCreatorResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
