 ...
 * 
 */
public abstract class TideReplicaManagerResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(TideReplicaManagerResourceBase.class);

	private TideReplicaManagerResourceConfiguration configuration;
    ...
    public TideReplicaManagerResourceBase() {
    }
	...
	public TideReplicaManagerResourceConfiguration getConfiguration() {
		...
		servicePath+="/TideReplicaManager";
		...
		try {
			...
			this.configuration = (TideReplicaManagerResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
