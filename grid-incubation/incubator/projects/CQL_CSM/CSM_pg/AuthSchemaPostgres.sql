...
CREATE SEQUENCE csm_filter_clause_filte_id_seq INCREMENT -1 ;
...
CREATE TABLE CSM_FILTER_CLAUSE ( 
	...
	GENERATED_SQL_USER character varying NOT NULL,
	GENERATED_SQL_GROUP character varying NOT NULL,
...
APPLICATION_DESCRIPTION character varying NOT NULL,
UPDATE_DATE date NOT NULL default current_date,
...
PRIVILEGE_DESCRIPTION character varying,
UPDATE_DATE date NOT NULL default current_date,
...
PROTECTION_ELEMENT_DESCRIPTION character varying,
...
PROTECTION_GROUP_DESCRIPTION character varying,
APPLICATION_ID int8 NOT NULL,
...
ADD CONSTRAINT UQ_PE_PE_NAME_ATTRIBUTE_APP_ID UNIQUE (OBJECT_ID, ATTRIBUTE, ATTRIBUTE_VALUE, APPLICATION_ID)
;
...
ALTER TABLE ONLY csm_remote_group
    ADD CONSTRAINT csm_remote_group_pkey PRIMARY KEY (group_id);

ALTER TABLE ONLY csm_remote_group_sync_record
    ADD CONSTRAINT csm_remote_group_sync_record_pkey PRIMARY KEY (record_id);

ALTER TABLE ONLY csm_remote_group_sync_record
    ADD CONSTRAINT fk2a8a7cfedb129989 FOREIGN KEY (group_id) REFERENCES csm_remote_group(group_id);
