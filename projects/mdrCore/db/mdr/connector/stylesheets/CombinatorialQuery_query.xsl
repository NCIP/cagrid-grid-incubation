...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:q="http://cagrid.org/schema/query">
    <xsl:template match="/">
        <resolveSet xmlns="http://lexbig.cagrid.org/xsd">
            ...
            <sDesignationTxt><xsl:value-of select="/q:query/q:term"/></sDesignationTxt>
            ...
            <iReturnItemIndexFrom><xsl:value-of select="/q:query/q:startIndex"/></iReturnItemIndexFrom>
            <iReturnItemIndexTo><xsl:value-of select="/q:query/q:numResults"/></iReturnItemIndexTo>
        </resolveSet>
    </xsl:template>
</xsl:stylesheet>
