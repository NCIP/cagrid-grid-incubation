<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="MetaThesaurusConcept">
        ...
        <concept>
            <names>
                <id>lexevsapi.nci.nih.gov_NCIMetaThesaurusConcept_<xsl:value-of select="Cui"/></id>
                <preferred>
    ...
    <xsl:template match="Definition">
        ...
        <source>
        	<abbreviation>
        		<xsl:value-of select="Source/Source/Abbreviation"/>
        	</abbreviation>
        	<code>
        		<xsl:value-of select="Source/Source/Code"/>
        	</code>
        	<description>
        		<xsl:value-of select="Source/Source/Description"/>
        	</description>
        </source>
    </xsl:template>
