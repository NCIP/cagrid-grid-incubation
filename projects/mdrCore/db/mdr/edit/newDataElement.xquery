              ...
              <tr>
                  ...
                  <td align="left" colspan="2">
                  {
                    if(request:get-parameter('data_element_concept_id','') eq "Cancel")  then (
                       ...
                       lib-forms:make-select-form-admin-item-edit-false('data_element_concept','data_element_concept_id', request:get-parameter('data_element_concept_id',''),'new_DataElement', 'Select Relationship') 
                  )
                  }
                  </td>
               </tr>
               <tr>
                  ...
                  <td align="left" colspan="2">
                  {
                    if(request:get-parameter('value_domain_id','') eq "Cancel")  then (
                        lib-forms:make-select-form-admin-item-edit-false('value_domain','value_domain_id', session:get-attribute("value_domain_id"),'new_DataElement', 'Change Relationship'),
                        ...
                        lib-forms:make-select-form-admin-item-edit-false('value_domain','value_domain_id', request:get-parameter('value_domain_id',''),'new_DataElement', 'Change Relationship'))
                    
                    else(
                       lib-forms:make-select-form-admin-item-edit-false('value_domain','value_domain_id', request:get-parameter('value_domain_id',''),'new_DataElement', 'Select Relationship') 
                  )
                  }
                  </td>
              </tr>
