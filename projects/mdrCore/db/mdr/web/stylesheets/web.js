...
function validate_AnnotatedModel ()
{
    ...
    if(validate_adminItems_reference_annotated()){
...
function deleteExistingContact(obj) {
    ...
    var val= confirm("Note: All existing references to this contact will be effected. Confirm delete?");
    if(val==true){
        d1.removeChild(d2);
    }
}
...
function validate_adminItems_reference_annotated ()
{
    valid = true;
    errors = new Array();
    i=0;
