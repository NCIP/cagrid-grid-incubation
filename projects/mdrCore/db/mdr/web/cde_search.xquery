...
<OpenSearchDescription xmlns:moz="http://www.mozilla.org/2006/browser/search/" xmlns="http://a9.com/-/spec/opensearch/1.1/">
    <ShortName>OpenMDR CDE Search</ShortName>
    <Description>OpenMDR CDE Search - First Search Plugin Test</Description>
    ...
    <Image height="16" width="16" type="../images/vnd.microsoft.icon">{$image-path}OpenMDRDotOnLight.ico</Image>
    <Query role="example" searchTerms="cancer"/>
    <Attribution>Copyright (C) 2006 The OpenMDR Consortium</Attribution>
