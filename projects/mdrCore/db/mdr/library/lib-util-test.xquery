...
return
    lib-rendering:txfrm-webpage(
        ...
        element function-tests {
            test:expression("lib-util:mdrElementId/1", lib-util:mdrElementId($test:organization-GB-OPENMDR-000002-1), "lib-util:mdrElementId($test:organization-GB-OPENMDR-000002-1)", "GB-OPENMDR-000002-1"),
            ...
            test:expression("lib-util:mdrElementId/1", lib-util:mdrElementId($test:context-GB-OPENMDR-000001-1), "lib-util:mdrElementId($test:context-GB-OPENMDR-000001-1)", "GB-OPENMDR-000001-1"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:conceptual-domain-GB-OPENMDR-0E57DB56A-0.1), "lib-util:mdrElementType($test:conceptual-domain-GB-OPENMDR-0E57DB56A-0.1)", "conceptual_domain"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:value-domain-GB-OPENMDR-006BB338C-0.1), "lib-util:mdrElementType($test:value-domain-GB-OPENMDR-006BB338C-0.1)", "value_domain"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:object-class-GB-OPENMDR-3E5B7BE69-0.1), "lib-util:mdrElementType($test:object-class-GB-OPENMDR-3E5B7BE69-0.1)", "object_class"),
            ...
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:classification-scheme-GB-OPENMDR-000026-1.0), "lib-util:mdrElementType($test:classification-scheme-GB-OPENMDR-000026-1.0)", "classification_scheme"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:context-GB-OPENMDR-000001-1), "lib-util:mdrElementType($test:context-GB-OPENMDR-000001-1)", "context"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:data-element-GB-OPENMDR-0A296A56A-0.1), "lib-util:mdrElementType($test:data-element-GB-OPENMDR-0A296A56A-0.1)", "data_element"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:data-element-concept-GB-OPENMDR-3B90B6D4C-0.1), "lib-util:mdrElementType($test:data-element-concept-GB-OPENMDR-3B90B6D4C-0.1)", "data_element_concept"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:organization-GB-OPENMDR-000002-1), "lib-util:mdrElementType($test:organization-GB-OPENMDR-000002-1)", "organization"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:property-GB-OPENMDR-4A4B57291-0.1), "lib-util:mdrElementType($test:property-GB-OPENMDR-4A4B57291-0.1)", "property"),
            ...
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:registration-authority-GB-OPENMDR-CA), "lib-util:mdrElementType($test:registration-authority-GB-OPENMDR-CA)", "registration_authority"),
            test:expression("lib-util:mdrElementType/1", lib-util:mdrElementType($test:representation-class-GB-OPENMDR-000010-1), "lib-util:mdrElementType($test:representation-class-GB-OPENMDR-000010-1)", "representation_class"),
