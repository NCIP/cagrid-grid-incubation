			...
			if(!(args.length < 2)){
				if(args[0].equals("-url")){
					...
					if( containerIsSecure ){
						...
						EndpointReferenceType delegationEPR6 = delegateCredential(myCredential, wf_helper.getIdentity(), cds_URL, delegationLifetime, issuedCredentialLifetime, 
								delegationPath, issuedCredentialPath);
