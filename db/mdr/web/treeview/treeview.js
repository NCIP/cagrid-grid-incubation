...
function findElementInTreeview(adminItemID)
{
    var myNode=document.getElementById(adminItemID);
    openTree(myNode);
}
...
function selectLeaf(code) {
    myRef = window.open('../web/data_element_summary.xquery?compound_id='+code,'_parent');
}

function selectFolder(title, code) {
}
