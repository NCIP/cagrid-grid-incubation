 ...
 * 
 */
public abstract class Service5ResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(Service5ResourceBase.class);

	private Service5ResourceConfiguration configuration;
	...
	public Service5ResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Service5ResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
