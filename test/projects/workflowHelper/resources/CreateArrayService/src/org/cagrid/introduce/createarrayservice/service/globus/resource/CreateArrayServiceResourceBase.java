...
import org.cagrid.introduce.createarrayservice.service.CreateArrayServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class CreateArrayServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(CreateArrayServiceResourceBase.class);

	private CreateArrayServiceResourceConfiguration configuration;
    ...
    public CreateArrayServiceResourceBase() {
    }
	...
	public CreateArrayServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/CreateArrayService";
		...
		try {
			...
			this.configuration = (CreateArrayServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
