 ...
 * 
 */
public abstract class ReceiveArrayServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(ReceiveArrayServiceResourceBase.class);

	private ReceiveArrayServiceResourceConfiguration configuration;
    ...
    public ReceiveArrayServiceResourceBase() {
    }
	...
	public ReceiveArrayServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/ReceiveArrayService";
		...
		try {
			...
			this.configuration = (ReceiveArrayServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
